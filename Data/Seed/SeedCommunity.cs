        ...
        private static async Task NewsAsync(AppDbContext db)
        {
            ...
            db.NewsPosts.AddRange(
                new NewsPost
                {
                    ...
                    AuthorName = "SVEI",
                    CoverImagePath = "/img/news/opening.webp",
                ...
                new NewsPost
                {
                    ...
                    AuthorName = "SVEI",
                    CoverImagePath = "/img/lines/wearables.webp",
                ...
                new NewsPost
                {
                    ...
                    AuthorName = "SVEI",
                    CoverImagePath = "/img/news/partnership.webp",
        ...
        private static async Task EventsAsync(AppDbContext db)
        {
            ...
            db.Events.AddRange(
                new Event
                {
                    ...
                    CoverImagePath = "/img/events/expo.webp",
                ...
                new Event
                {
                    ...
                    AllowRegistration = true,
                    Capacity = 60,
                    CoverImagePath = "/img/events/open-day.webp",
                ...
                new Event
                {
                    ...
                    CoverImagePath = "/img/events/training.webp",
